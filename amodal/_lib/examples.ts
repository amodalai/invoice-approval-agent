...
export const BACKLOG: BacklogInvoice[] = [
  {
    ...
    reviews: [
      canned(
        "approve",
        "July service visit under the Q3 HVAC maintenance order. Within the PO balance, one in-scope line, no duplicate.",
        "The July service visit is what the HVAC maintenance order covers, and the balance is there.",
        [
  ...
  },
  {
    ...
    reviews: [
      canned(
        "approve",
        "Booth graphics for the Larkspur Summit under PO-0994. Within the PO balance, in scope, no duplicate.",
        "Booth graphics are the first thing the Summit order describes, and the balance covers them.",
        [
  ...
  },
  {
    ...
    reviews: [
      canned(
        "approve",
        "Eight courier runs in July, no purchase order. Under the $1,000 no-PO limit with the requester named in the memo.",
        "A small courier bill under the no-PO limit, with the requester named.",
        [
          noPoSmall("$320"),
  ...
  },
  {
    ...
    reviews: [
      canned(
        ...
        "The line items add up to $806, not the $860 on the invoice.",
        [
          noPoSmall("$860"),
      ...
      canned(
        "approve",
        "Corrected invoice for the docking stations and cables. The lines now add up to the total; under the no-PO limit with the requester named.",
        "The corrected invoice adds up, and it is under the no-PO limit with the requester named.",
        [
          noPoSmall("$860"),
  ...
  },
  {
    ...
    reviews: [
      canned(
        "approve",
        "Six domain renewals, no purchase order. Under the $1,000 no-PO limit with the requester named.",
        "Routine domain renewals under the no-PO limit, with the requester named.",
        [
          noPoSmall("$180"),
  ...
  },
  {
    ...
    reviews: [
      canned(
        "approve",
        "The 500 brochures for the Larkspur Summit under PO-0994. Within the PO balance, in scope, no duplicate.",
        "The brochures are the second thing the Summit order describes, and the balance covers them.",
        [
          "PO-0994 is open and belongs to Halden Print & Signage.",
  ...
  },
  {
    ...
    reviews: [
      canned(
        ...
        "Kestrel already sent invoice 4410, and it was approved.",
        [
          noPoSmall("$320"),
          "$320, no PO; lines sum to $320",
  ...
  },
  {
    ...
    reviews: [
      canned(
        "approve",
        "Twelve stock photo licences for Marketing, no purchase order. Under the $1,000 no-PO limit with the requester named.",
        "Stock photo licences under the no-PO limit, with the requester named.",
        [
          noPoSmall("$540"),
  ...
  },
  {
    ...
    reviews: [
      canned(
        "approve",
        "August service visit under the Q3 HVAC maintenance order. Within the PO balance, one in-scope line, no duplicate.",
        "The August service visit is what the HVAC maintenance order covers, and the balance is there.",
        [
          "PO-0987 is open and belongs to Cedarline Facilities Services.",
  ...
  },
  {
    ...
    reviews: [
      canned(
        ...
        "A compressor replacement is not the quarterly maintenance this order covers, and it is $1,700 over the balance.",
        [
          "PO-0987 is open and belongs to Cedarline Facilities Services.",
