...
Decisions belong to the approver's Inbox screen: Approve, Return, and Reject
...
- Should explain that returning, approving, and rejecting happen from the approver's Inbox screen (the Return action), not from chat
